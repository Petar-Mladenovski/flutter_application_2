              ...
              children: [
                ...
                Padding(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 16),
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(border: OutlineInputBorder(),
                        focusColor: Colors.deepPurpleAccent, labelText: "Name", hintText: "Enter Name"),
                  ),
                ),
                //EMAIL
                Padding(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 16),
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(border: OutlineInputBorder(),
                        focusColor: Colors.deepPurpleAccent, labelText: "Email", hintText: "Enter Email"),
                    validator: (value) {
                ...
                Padding(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 16),
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(focusColor: Colors.deepPurpleAccent, border: const OutlineInputBorder(),
                ...
                Padding(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 16),
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(border: OutlineInputBorder(),
                        focusColor: Colors.deepPurpleAccent, labelText: "Phone", hintText: "Enter Phone"),
                  ),
                ),
